...
namespace WebAPI
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<MessageRoomDbContext>(options =>
            {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "Swagger MessageRoomSolution",
                    Version = "v1",
                    Description = "This is Halinhit's MessageRoomSolution Backend."
                });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Swagger MessageRoom v1");
            });
